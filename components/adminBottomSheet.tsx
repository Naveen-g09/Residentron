...
const Admin = forwardRef<Ref>((props, ref) => {
  ...
  return (
    <BottomSheetModal ref={ref} index={2} snapPoints={snapPoints}>
      <View style={styles.contentContainer}>
        <Text style={styles.containerHeadline}>Personal details</Text>
        <>
              ...
              <View style={styles.detailsContainer}>
                {editMode ? (
                  <>
                    ...
                    <View
                      style={[styles.inputContainer, styles.phoneNumberInput]}
                    >
