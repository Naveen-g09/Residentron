...
const Varsha = () => {
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={[styles.gridItem, styles.gridA]} onPress={() => fetchWingData('a')}>
                <Text style={styles.gridText}>A</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.gridItem, styles.gridB]} onPress={() => fetchWingData('b')}>
                <Text style={styles.gridText}>B</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.gridItem, styles.gridC]} onPress={() => fetchWingData('c')}>
                <Text style={styles.gridText}>C</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.gridItem, styles.gridD]} onPress={() => fetchWingData('d')}>
